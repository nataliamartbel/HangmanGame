...
def main():
    welcome = ['Welcome to Hangman! A word will be chosen at random and',
               ...
               'before runninout of tries. Best of luck!'
               ]
    ...
    while play_again:
        ...
        words = ["hangman", "chairs", "backpack", "technology", "clothing",
                 "computer", "frame", "program", "glasses", "college",
                 "project", "mattress", "friends", "vecna", "genius",
                 "algebra", "goal", "python", "eleven", "dog"
                 ]
